      ...
      <div class="container clearfix">
        ...
        <div class="logo">
          <a class="logo__link" href="../index.php">
            <img class="logo__img" src="./images/pop.png" alt="CROPFIT" width="80" height="19">
          </a>
        </div>
        ...
        <nav class="main-nav">
          ...
          <li class="categories__item">
              <a class="categories__link" href="../pulses.php?cat=7">
                Pulses
              </a>
            </li>

            <li class="categories__item">
              <a class="categories__link" href="../pulses.php?cat=8">
                Fruits
              </a>
            </li>

            <li class="categories__item">
              <a class="categories__link" href="../pulses.php?cat=9">
                Vegetables
              </a>
            </li>

            <li class="categories__item">
              <a class="categories__link" href="../blogs.php">
                Blog
              </a>
            </li>
